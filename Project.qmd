...
The code below aims to collect all of the temperature data into one dictionary repository.
...
We will be training and testing the temperature data on the same
```{julia}
